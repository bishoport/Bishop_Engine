...
namespace ECS
{
    ...
    public:
        ...
        { 
            ...
            cubemapTexture = GLCore::Loaders::loadCubemap(faces);
        }

        void setShaders(GLCore::Shader* _skyboxShader)
        {
        ...
        void DrawSkybox(glm::mat4 view, glm::mat4 projection)
        {
            ...
            view = glm::mat4(glm::mat3(view)); // Elimina la traslación, manteniendo solo la rotación
        ...
        //unsigned int* externalCubemapTexture = nullptr;
